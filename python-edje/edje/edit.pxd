...
cdef extern from "Edje_Edit.h":
    ...
    char* edje_edit_compiler_get(Evas_Object *obj)
    ...
    Eina_Bool edje_edit_data_add(Evas_Object *obj, char *itemname, char *value)
    Eina_Bool edje_edit_data_del(Evas_Object *obj, char *itemname)
    char * edje_edit_data_value_get(Evas_Object * obj, char *itemname)
    Eina_Bool edje_edit_data_value_set(Evas_Object * obj, char *itemname, char *value)
    Eina_Bool edje_edit_data_name_set(Evas_Object *obj, char *itemname, char *newname)

    Eina_List * edje_edit_group_data_list_get(Evas_Object *obj)
    Eina_Bool edje_edit_group_data_add(Evas_Object *obj, char *itemname, char *value)
    Eina_Bool edje_edit_group_data_del(Evas_Object *obj, char *itemname)
    char * edje_edit_group_data_value_get(Evas_Object * obj, char *itemname)
    Eina_Bool edje_edit_group_data_value_set(Evas_Object * obj, char *itemname, char *value)
    Eina_Bool edje_edit_group_data_name_set(Evas_Object *obj, char *itemname, char *newname)

    # COLOR CLASSES API
    Eina_List * edje_edit_color_classes_list_get(Evas_Object * obj)
    Eina_Bool edje_edit_color_class_add(Evas_Object *obj, char *name)
    Eina_Bool edje_edit_color_class_del(Evas_Object *obj, char *name)
    Eina_Bool edje_edit_color_class_colors_get(Evas_Object *obj, char *class_name, int *r, int *g, int *b, int *a, int *r2, int *g2, int *b2, int *a2, int *r3, int *g3, int *b3, int *a3)
    Eina_Bool edje_edit_color_class_colors_set(Evas_Object *obj, char *class_name, int r, int g, int b, int a, int r2, int g2, int b2, int a2, int r3, int g3, int b3, int a3)
    Eina_Bool edje_edit_color_class_name_set(Evas_Object *obj, char *name, char *newname)

    # TEXT STYLES
    Eina_List * edje_edit_styles_list_get(Evas_Object *obj)
    Eina_Bool edje_edit_style_add(Evas_Object *obj, char *style)
    void edje_edit_style_del(Evas_Object *obj, char *style)
    Eina_List * edje_edit_style_tags_list_get(Evas_Object *obj, char *style)
    char* edje_edit_style_tag_value_get(Evas_Object *obj, char *style, char *tag)
    void edje_edit_style_tag_value_set(Evas_Object *obj, char *style, char *tag, char *new_value)
    void edje_edit_style_tag_name_set(Evas_Object *obj, char *style, char *tag, char *new_name)
    Eina_Bool edje_edit_style_tag_add(Evas_Object *obj, char *style, char* tag_name)
    void edje_edit_style_tag_del(Evas_Object *obj, char *style, char* tag)

    # EXTERNALS API
    Eina_List *edje_edit_externals_list_get(Evas_Object *obj)
    Eina_Bool edje_edit_external_add(Evas_Object *obj, char *name)
    Eina_Bool edje_edit_external_del(Evas_Object *obj, char *name)

    # PARTS API
    Eina_List * edje_edit_parts_list_get(Evas_Object *obj)
    Eina_Bool edje_edit_part_add(Evas_Object *obj, char *name, Edje_Part_Type type)
    Eina_Bool edje_edit_part_external_add(Evas_Object *obj, char *name, char *source)
    Eina_Bool edje_edit_part_del(Evas_Object *obj, char *part)
    Eina_Bool edje_edit_part_exist(Evas_Object *obj, char *part)
    char * edje_edit_part_above_get(Evas_Object *obj, char *part)
    char * edje_edit_part_below_get(Evas_Object *obj, char *part)
    Eina_Bool edje_edit_part_restack_below(Evas_Object *obj, char *part)
    Eina_Bool edje_edit_part_restack_above(Evas_Object *obj, char *part)
    Eina_Bool edje_edit_part_name_set(Evas_Object *obj, char  *part, char  *new_name)
    Edje_Part_Type edje_edit_part_type_get(Evas_Object *obj, char *part)
    char * edje_edit_part_clip_to_get(Evas_Object *obj, char *part)
    Eina_Bool edje_edit_part_clip_to_set(Evas_Object *obj, char *part, char *clip_to)
    char * edje_edit_part_source_get(Evas_Object *obj, char *part)
    Eina_Bool edje_edit_part_source_set(Evas_Object *obj, char *part, char *source)
    Edje_Text_Effect edje_edit_part_effect_get(Evas_Object *obj, char *part)
    void edje_edit_part_effect_set(Evas_Object *obj, char *part, Edje_Text_Effect effect)
    char * edje_edit_part_selected_state_get(Evas_Object *obj, char *part, double *value)
    Eina_Bool edje_edit_part_selected_state_set(Evas_Object *obj, char *part, char *state, double value)
    Eina_Bool edje_edit_part_mouse_events_get(Evas_Object *obj, char *part)
    void edje_edit_part_mouse_events_set(Evas_Object *obj, char *part, Eina_Bool mouse_events)
    Eina_Bool edje_edit_part_repeat_events_get(Evas_Object *obj, char *part)
    void edje_edit_part_repeat_events_set(Evas_Object *obj, char *part, Eina_Bool repeat_events)
    Evas_Event_Flags edje_edit_part_ignore_flags_get(Evas_Object *obj, char *part)
    void edje_edit_part_ignore_flags_set(Evas_Object *obj, char *part, Evas_Event_Flags ignore_flags)
    void edje_edit_part_scale_set(Evas_Object *obj, char *part, Eina_Bool scale)
    Eina_Bool edje_edit_part_scale_get(Evas_Object *obju, char *part)
    int edje_edit_part_drag_x_get(Evas_Object *obj, char *part)
    void edje_edit_part_drag_x_set(Evas_Object *obj, char *part, int drag)
    int edje_edit_part_drag_y_get(Evas_Object *obj, char *part)
    void edje_edit_part_drag_y_set(Evas_Object *obj, char *part, int drag)
    int edje_edit_part_drag_step_x_get(Evas_Object *obj, char *part)
    void edje_edit_part_drag_step_x_set(Evas_Object *obj, char *part, int step)
    int edje_edit_part_drag_step_y_get(Evas_Object *obj, char *part)
    void edje_edit_part_drag_step_y_set(Evas_Object *obj, char *part, int step)
    int edje_edit_part_drag_count_x_get(Evas_Object *obj, char *part)
    void edje_edit_part_drag_count_x_set(Evas_Object *obj, char *part, int count)
    int edje_edit_part_drag_count_y_get(Evas_Object *obj, char *part)
    void edje_edit_part_drag_count_y_set(Evas_Object *obj, char *part, int count)
    char* edje_edit_part_drag_confine_get(Evas_Object *obj, char *part)
    void edje_edit_part_drag_confine_set(Evas_Object *obj, char *part, char *confine)
    char* edje_edit_part_drag_event_get(Evas_Object *obj, char *part)
    void edje_edit_part_drag_event_set(Evas_Object *obj, char *part, char *event)
    char* edje_edit_part_api_name_get(Evas_Object *obj, char *part)
    char* edje_edit_part_api_description_get(Evas_Object *obj, char *part)
    Eina_Bool edje_edit_part_api_name_set(Evas_Object *obj, char *part, char *name)
    Eina_Bool edje_edit_part_api_description_set(Evas_Object *obj, char *part, char *description)
    char* edje_edit_program_api_name_get(Evas_Object *obj, char *part)
    char* edje_edit_program_api_description_get(Evas_Object *obj, char *part)
    Eina_Bool edje_edit_program_api_name_set(Evas_Object *obj, char *part, char *name)
    Eina_Bool edje_edit_program_api_description_set(Evas_Object *obj, char *part, char *description)
    ...
    Eina_Bool edje_edit_state_external_param_get(Evas_Object *obj, char *part, char *state, double value, char *param, Edje_External_Param_Type *type, void **val)
    ...
    Eina_Bool edje_edit_state_external_param_set(Evas_Object *obj, char *part, char *state, double value, char *param, Edje_External_Param_Type type, ...)
    ...
    # TEXT API
    char * edje_edit_state_text_get(Evas_Object *obj, char *part, char *state, double value)
    void edje_edit_state_text_set(Evas_Object *obj, char *part, char *state, double value, char *text)
    int edje_edit_state_text_size_get(Evas_Object *obj, char *part, char *state, double value)
    void edje_edit_state_text_size_set(Evas_Object *obj, char *part, char *state, double value, int size)
    double edje_edit_state_text_align_x_get(Evas_Object *obj, char *part, char *state, double value)
    double edje_edit_state_text_align_y_get(Evas_Object *obj, char *part, char *state, double value)
    void edje_edit_state_text_align_x_set(Evas_Object *obj, char *part, char *state, double value, double align)
    void edje_edit_state_text_align_y_set(Evas_Object *obj, char *part, char *state, double value, double align)
    double edje_edit_state_text_elipsis_get(Evas_Object *obj, char *part, char *state, double value)
    void edje_edit_state_text_elipsis_set(Evas_Object *obj, char *part, char *state, double value, double balance)
    Eina_Bool edje_edit_state_text_fit_x_get(Evas_Object *obj, char *part, char *state, double value)
    void edje_edit_state_text_fit_x_set(Evas_Object *obj, char *part, char *state, double value, Eina_Bool fit)
    Eina_Bool edje_edit_state_text_fit_y_get(Evas_Object *obj, char *part, char *state, double value)
    void edje_edit_state_text_fit_y_set(Evas_Object *obj, char *part, char *state, double value, Eina_Bool fit)
    Eina_List * edje_edit_fonts_list_get(Evas_Object *obj)
    Eina_Bool edje_edit_font_add(Evas_Object *obj, char* path, char* alias)
    Eina_Bool edje_edit_font_del(Evas_Object *obj, char* alias)
    char * edje_edit_state_font_get(Evas_Object *obj, char *part, char *state, double value)
    void edje_edit_state_font_set(Evas_Object *obj, char *part, char *state, double value, char *font)

    # IMAGES API
    Eina_List * edje_edit_images_list_get(Evas_Object *obj)
    Eina_Bool edje_edit_image_add(Evas_Object *obj, char* path)
    Eina_Bool edje_edit_image_del(Evas_Object *obj, char* name)
    Eina_Bool edje_edit_image_data_add(Evas_Object *obj, char *name, int id)
    char * edje_edit_state_image_get(Evas_Object *obj, char *part, char *state, double value)
    void edje_edit_state_image_set(Evas_Object *obj, char *part, char *state, double value, char *image)
    int edje_edit_image_id_get(Evas_Object *obj, char *image_name)
    Edje_Edit_Image_Comp edje_edit_image_compression_type_get(Evas_Object *obj, char *image)
    int edje_edit_image_compression_rate_get(Evas_Object *obj, char *image)
    void edje_edit_state_image_border_get(Evas_Object *obj, char *part, char *state, double value, int *l, int *r, int *t, int *b)
    void edje_edit_state_image_border_set(Evas_Object *obj, char *part, char *state, double value, int l, int r, int t, int b)
    unsigned char edje_edit_state_image_border_fill_get(Evas_Object *obj, char *part, char *state, double value)
    void edje_edit_state_image_border_fill_set(Evas_Object *obj, char *part, char *state, double value, unsigned char fill)
    Eina_List * edje_edit_state_tweens_list_get(Evas_Object *obj, char *part, char *state, double value)
    Eina_Bool edje_edit_state_tween_add(Evas_Object *obj, char *part, char *state, double value, char *tween)
    Eina_Bool edje_edit_state_tween_del(Evas_Object *obj, char *part, char *state, double value, char *tween)

    # PROGRAMS API
    Eina_List* edje_edit_programs_list_get(Evas_Object *obj)
    Eina_Bool edje_edit_program_add(Evas_Object *obj, char *name)
    Eina_Bool edje_edit_program_del(Evas_Object *obj, char *prog)
    Eina_Bool edje_edit_program_exist(Evas_Object *obj, char *prog)
    Eina_Bool edje_edit_program_run(Evas_Object *obj, char *prog)
    Eina_Bool edje_edit_program_name_set(Evas_Object *obj, char *prog, char *new_name)
    char * edje_edit_program_source_get(Evas_Object *obj, char *prog)
    Eina_Bool edje_edit_program_source_set(Evas_Object *obj, char *prog, char *source)
    char * edje_edit_program_signal_get(Evas_Object *obj, char *prog)
    Eina_Bool edje_edit_program_signal_set(Evas_Object *obj, char *prog, char *signal)
    double edje_edit_program_in_from_get(Evas_Object *obj, char *prog)
    Eina_Bool edje_edit_program_in_from_set(Evas_Object *obj, char *prog, double seconds)
    double edje_edit_program_in_range_get(Evas_Object *obj, char *prog)
    Eina_Bool edje_edit_program_in_range_set(Evas_Object *obj, char *prog, double seconds)
    Edje_Action_Type edje_edit_program_action_get(Evas_Object *obj, char *prog)
    Eina_Bool edje_edit_program_action_set(Evas_Object *obj, char *prog, Edje_Action_Type action)
    Eina_List* edje_edit_program_targets_get(Evas_Object *, char *prog)
    Eina_Bool edje_edit_program_target_add(Evas_Object *obj, char *prog, char *target)
    Eina_Bool edje_edit_program_target_del(Evas_Object *obj, char *prog, char *target)
    Eina_Bool edje_edit_program_targets_clear(Evas_Object *obj, char *prog)
    Eina_List* edje_edit_program_afters_get(Evas_Object *obj, char *prog)
    Eina_Bool edje_edit_program_after_add(Evas_Object *obj, char *prog, char *after)
    Eina_Bool edje_edit_program_after_del(Evas_Object *obj, char *prog, char *after)
    Eina_Bool edje_edit_program_afters_clear(Evas_Object *obj, char *prog)
    char* edje_edit_program_state_get(Evas_Object *obj, char *prog)
    Eina_Bool edje_edit_program_state_set(Evas_Object *obj, char *prog, char *state)
    double edje_edit_program_value_get(Evas_Object *obj, char *prog)
    Eina_Bool edje_edit_program_value_set(Evas_Object *obj, char *prog, double value)
    char* edje_edit_program_state2_get(Evas_Object *obj, char *prog)
    Eina_Bool edje_edit_program_state2_set(Evas_Object *obj, char *prog, char *state2)
    double edje_edit_program_value2_get(Evas_Object *obj, char *prog)
    Eina_Bool edje_edit_program_value2_set(Evas_Object *obj, char *prog, double value)
    Edje_Tween_Mode edje_edit_program_transition_get(Evas_Object *obj, char *prog)
    Eina_Bool edje_edit_program_transition_set(Evas_Object *obj, char *prog, Edje_Tween_Mode transition)
    double edje_edit_program_transition_time_get(Evas_Object *obj, char *prog)
    Eina_Bool edje_edit_program_transition_time_set(Evas_Object *obj, char *prog, double seconds)

    # SCRIPTS API
    char* edje_edit_script_get(Evas_Object *obj)
    void  edje_edit_script_set(Evas_Object *obj, const_char_ptr code)
    char* edje_edit_script_program_get(Evas_Object *obj, const_char_ptr prog)
    void  edje_edit_script_program_set(Evas_Object *obj, const_char_ptr prog, const_char_ptr code)
    Eina_Bool edje_edit_script_compile(Evas_Object *obj)
    const_Eina_List * edje_edit_script_error_list_get(Evas_Object *obj)


cdef public class EdjeEdit(Edje) [object PyEdjeEdit, type PyEdjeEdit_Type]:
    pass
