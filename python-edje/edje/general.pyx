...
cimport libc.stdlib
from evas.general cimport Eina_Bool, Eina_List, eina_list_free, eina_iterator_next, eina_iterator_free
from evas.object import EvasObjectMeta, _object_mapping_register
from evas.object cimport Object_from_instance
from evas.callbacks cimport EVAS_CALLBACK_FREE
...
class EdjeObjectMeta(EvasObjectMeta):
