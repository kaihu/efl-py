...
# This file is included verbatim by pyx
#from evas.general cimport
import traceback
...
cdef public class Edje(Object) [object PyEdje, type PyEdje_Type]:
    """Edje evas object.

    This is a high level L{evas.SmartObject} that is defined as a group of
    parts (L{Object}, usually written in text files (.edc) and
    ...
    cdef int _set_obj(self, Evas_Object *obj) except 0:
        cdef int r
        r = Object._set_obj(self, obj)
        if r == 1:
            self.event_callback_add(EVAS_CALLBACK_FREE,
    ...
    def part_object_get(self, char *part):
        """Get L{Object} that represents this part.
    ...
    def part_swallow(self, char *part, Object obj):
    ...
    def part_box_append(self, char *part, Object obj):
    ...
    def part_box_prepend(self, char *part, Object obj):
        """Adds an item to a BOX part.
    ...
    def part_box_insert_at(self, char *part, Object obj,
                           unsigned int pos):
    ...
    def part_box_insert_before(self, char *part, Object obj,
                               Object reference):
    ...
    def part_box_remove(self, char *part, Object obj):
    ...
    def part_table_pack(self, char *part, Object child, short col, short row, short colspan, short rowspan):
    ...
    def part_table_unpack(self, char *part, Object child):
