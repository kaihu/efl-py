...
cdef class Fileselector(LayoutClass):
    ...
    the system. This custom file name will be reported on the ``"done"``
    ...
    def __init__(self, evasObject parent):
        ...
        :return: a new file selector widget handle or *None*, on errors
...
_install_metaclass(Fileselector)
