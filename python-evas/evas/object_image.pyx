...
cdef class Image(Object):
    ...
    Image will consider the object's :py:func:`geometry<Object.geometry_set()>` as
    the area to paint with tiles as described by :py::`fill_set()` and the real
...
_install_metaclass(FilledImage)
