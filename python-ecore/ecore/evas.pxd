...
#        Ecore_DirectFB_Cursor *cursor
    ...
    int ecore_evas_object_associate(Ecore_Evas *ee, Evas_Object *obj, Ecore_Evas_Object_Associate_Flags flags)
    int ecore_evas_object_dissociate(Ecore_Evas *ee, Evas_Object *obj)
    Evas_Object *ecore_evas_object_associate_get(Ecore_Evas *ee)
