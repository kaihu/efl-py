...
from evas.canvas cimport Canvas, Canvas_from_instance
from evas.object cimport Object, Object_from_instance
import traceback
...
cdef class EcoreEvas:
    ...
    cdef int _set_obj(EcoreEvas self, Ecore_Evas *obj) except 0:
        ...
        self.evas = Canvas_from_instance(ecore_evas_get(obj))
    ...
    def cursor_set(self, cursor, int layer=0, int hotx=0, int hoty=0):
        ...
        @parm: B{cursor} either filename or L{Object}
        @parm: B{layer}
    ...
    def associate(self, Object obj, int flags=0):
    ...
    def dissociate(self, Object obj):
    ...
    def associate_get(self):
        ...
        if eobj == NULL:
            ...
            return Object_from_instance(eobj)
