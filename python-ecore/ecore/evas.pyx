...
def engine_name_from_type(int type_id):
    ...
    @rtype: str
    """
    for name, id in engine_id_mapping.iteritems():
        if id == type_id:
            return name
    return None
...
include "evas_base.pxi"
include "evas_base_x11.pxi"
include "evas_software_x11.pxi"
include "evas_gl_x11.pxi"
include "evas_xrender_x11.pxi"
include "evas_fb.pxi"
include "evas_buffer.pxi"
include "evas_software_x11_16.pxi"
